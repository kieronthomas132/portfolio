...
const ProjectsCard = ({
    ...
    return (
        ...
        >
            <section
                className="2xl:w-[440px] w-auto mx-auto rounded-t-lg hover:shadow-[#C0A790] hover:shadow-xl border-2 border-[#623D2F]">
                ...
                <div
                    className="w-[90%] flex items-center justify-between mx-auto mt-[40px] font-[500] mb-[20px] text-[17px]">
                    <a>View Project</a>
