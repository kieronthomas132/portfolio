...
const YEO = () => {
  return (
    <div className="grid text-center xs:w-[95%] sm:w-[530px] gap-3 h-[150px] grid-cols-2">
      <motion.div initial={{opacity: 0}} animate={{opacity: 1, transition: {delay: 0.6} }} className="bg-[#101010] relative flex flex-col w-full justify-center border-2 border-[#191919] rounded-2xl">
        ...
        <p className="text-[60px] text-[#999999]">15</p>
        <span className="flex mb-3 justify-center">
          <div className="flex items-center text-[#CCCCCC] border-2 border-[#191919] xs:text-[13px] text-sm font-[500] bg-[#141414] rounded-full gap-2 p-2 w-[80%] text-center justify-center">
            <FaFlag className="text-[#A291FD] text-[20px]" />
            <h4>Projects</h4>
          </div>
        </span>
      </motion.div>
